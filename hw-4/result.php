<?PHP
    ...
    include ("connection_database.php");
        // if(isset($_POST['movie_name']) and isset($_POST['action_movie']) and isset($_POST['drama_movie'])
        // and isset($_POST['horror_movie']) and isset($_POST['comedy_movie']) and isset($_POST['sf_movie'])
        // and isset($_POST['romance_movie']) and isset($_POST['thriller_movie']) and isset($_POST['animation_movie'])
        // and isset($_POST['mistery_movie']) and isset($_POST['documentary_movie'])){
        //     echo "Greska";
        // }
        ...
        if(isset($_POST['movie_name']) and empty($_POST['action_movie']) and empty($_POST['drama_movie'])
        and empty($_POST['horror_movie']) and empty($_POST['comedy_movie']) and empty($_POST['sf_movie'])
        and empty($_POST['romance_movie']) and empty($_POST['thriller_movie']) and empty($_POST['animation_movie'])
        and empty($_POST['mistery_movie']) and empty($_POST['documentary_movie'])){
        ...
        or isset($_POST['mistery_movie']) or isset($_POST['documentary_movie'])){
           ...
           $query_4 = "SELECT title, genre FROM movie_list;";
           ...
           while($row = mysqli_fetch_array($result_1)){
               ...
               else if( $string_result_2 >= 0){
                echo "<li class=\"list_dot\" \"list_item\">" . $row['title'] . "</li>";
                }
                else if( $string_result_3 >= 0){
                    echo "<li class=\"list_dot\" \"list_item\">" . $row['title'] . "</li>";
                }
                else if( $string_result_4 >= 0){
                    echo "<li class=\"list_dot\" \"list_item\">" . $row['title'] . "</li>";
                }
                else if( $string_result_5 >= 0){
                    echo "<li class=\"list_dot\" \"list_item\">" . $row['title'] . "</li>";
                }
                else if( $string_result_6 >= 0){
                    echo "<li class=\"list_dot\" \"list_item\">" . $row['title'] . "</li>";
                }
                else if( $string_result_7 >= 0){
                    echo "<li class=\"list_dot\" \"list_item\">" . $row['title'] . "</li>";
                }
                else if( $string_result_8 >= 0){
                    echo "<li class=\"list_dot\" \"list_item\">" . $row['title'] . "</li>";
                }
                else if( $string_result_9 >= 0){
                    echo "<li class=\"list_dot\" \"list_item\">" . $row['title'] . "</li>";
                }
                else if( $string_result_10 >= 0){
                    echo "<li class=\"list_dot\" \"list_item\">" . $row['title'] . "</li>";
                }
           }
           echo "</ul>";
