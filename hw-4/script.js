...
function addMovie(){
    ...
    date_of_publishing = $("#date_of_publishing").val();
    if(!date_of_publishing){
        alert("Date of publishing is missing");
        return;
    }
    genre = $("#genre").val();
    if(!genre){
    ...
    if(!director){
        alert("Director is missing");
        return;
    }
    writer = $("#writer").val();
    if(!year){
        alert("Writer is missing");
        return;
    }
    production_com = $("#production_com").val();
    if(!year){
        alert("Production company name is missing");
        return;
    }
    ...
    if(rating < 0){
        alert("Rating can't be negative number");
        return;
    }
    if(rating > 10){
        alert("Rating can't be larger than 10");
        return;
    }
    voters = $("#voters").val();
    if(!voters){
        alert("Number of voters is missing");
        return;
    }
    if(voters < 0){
        alert("Number of voters can't be negative number");
        return;
    }
    actors = $("#actors").val();
    if(!rating){
        alert("List of actors is missing");
        return;
    }
    img = $("#img").val();
    if(!rating){
